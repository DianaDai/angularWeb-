...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $stateProvider
        ...
        .state('logins', {
            ...
            data: { pageTitle: 'Logins', specialClass: 'gray-bg' }
        })
        ...
        .state('tables.edit_employee', {
            url: "/edit_employee",
            templateUrl: "views/testDemo/edit_employee.html",
            data: { pageTitle: 'Edit', specialClass: 'gray-bg'},
            params:{params:null},
            /*resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
        ...
        .state('tables.register_employee', {
            url: "/register_employee",
            templateUrl: "views/testDemo/register_employee.html",
            data: { pageTitle: 'Register', specialClass: 'gray-bg'},
            params:{params:null},
            /*resolve: {
                loadPlugin: function ($ocLazyLoad) {
